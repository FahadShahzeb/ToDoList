            ...
            <View style={styles.container}>
                ...
                <View style={styles.buttonContainer}>
                    ...
                    <View style={styles.registerButtonContainer}>
                        ...
                        <TouchableOpacity style={styles.registerbuttonDesign} onPress={() => navigation.navigate('LoginScreen')}>
                            <Text style={[styles.registerbuttonText, { color: '#D8605B', fontFamily: 'Poppins_700Bold', fontSize: scale(15) }]}>Sign In</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
